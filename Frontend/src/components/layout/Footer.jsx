...
<footer class="bg-neutral-primary-soft">
    <div class="mx-auto w-full max-w-7xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
              <a href="https://flowbite.com/" class="flex items-center">
                  ...
                  <span class="text-heading self-center text-2xl font-semibold whitespace-nowrap">Athlete Arena</span>
              </a>
          </div>
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  ...
                  <ul class="text-body font-medium">
                      <li class="mb-4">
                          <a href="https://flowbite.com/" class="hover:underline">Athlete Arena</a>
                      </li>
                      <li>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-body sm:text-center">© 2026 <a href="https://flowbite.com/" class="hover:underline">AthleteArena</a>. All Rights Reserved.
          </span>
