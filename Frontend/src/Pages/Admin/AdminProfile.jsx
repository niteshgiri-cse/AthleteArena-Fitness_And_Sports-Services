      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Section title="Account Information">
            <FormField label="Full Name" name="name" value={user.name} edit={edit} onChange={handleChange} />
            <FormField label="Email" name="email" value={user.email} edit={edit} onChange={handleChange} />
            <FormField label="Phone" name="phone" value={user.phone} edit={edit} onChange={handleChange} />
            <FormField label="Location" name="location" value={user.location} edit={edit} onChange={handleChange} />
          </Section>
